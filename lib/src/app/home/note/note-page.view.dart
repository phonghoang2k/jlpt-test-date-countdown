...
class _NotePageState extends State<NotePage>
  ...
  Widget build(BuildContext context) {
    ...
    offsetAnimation = Tween(begin: 0.0, end: 5.0)
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: _colors
                                              .map((color) => InkWell(
                                            onTap: () => _noteCubit
                                                .setColorIndex(_colors
                                                .indexOf(color)),
                                            child: AnimatedContainer(
                                              duration: Duration(
                                                  milliseconds: 300),
                                              width: (_colors.indexOf(
                                                  color) ==
                                                  _noteCubit
                                                      .colorIndex)
                                                  ? SizeConfig
  ...
  Widget _note(
      {int index, String header, String time, String body, String color}) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.only(
                      left: offsetAnimation.value != 0
                          ? offsetAnimation.value + 5.0
                          : 0,
                      right: offsetAnimation.value != 0
                          ? 5 - offsetAnimation.value
                          : 0),
                  child: Stack(
                    children: [
                      Column(
                        children: [
                          ...
                          Container(
                              ...
                              width: SizeConfig.blockSizeHorizontal * 40,
                              decoration:
                                  BoxDecoration(color: Color(int.parse(color))),
                      ...
                      state is! EditMode
                          ? Positioned(
                              child: Checkbox(
                                  value:
                                      _noteCubit.selectedIndex.contains(index),
